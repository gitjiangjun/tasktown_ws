...
village_interfaces__srv__UpdateTask_Request__init(village_interfaces__srv__UpdateTask_Request * msg)
{
  ...
  if (!rosidl_runtime_c__int32__Sequence__init(&msg->tasks, 0)) {
    village_interfaces__srv__UpdateTask_Request__fini(msg);
    return false;
  }
  return true;
}
...
village_interfaces__srv__UpdateTask_Request__create()
{
  ...
  village_interfaces__srv__UpdateTask_Request * msg = (village_interfaces__srv__UpdateTask_Request *)allocator.allocate(sizeof(village_interfaces__srv__UpdateTask_Request), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(village_interfaces__srv__UpdateTask_Request));
  bool success = village_interfaces__srv__UpdateTask_Request__init(msg);
  if (!success) {
...
village_interfaces__srv__UpdateTask_Request__Sequence__init(village_interfaces__srv__UpdateTask_Request__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  village_interfaces__srv__UpdateTask_Request * data = NULL;

  if (size) {
    data = (village_interfaces__srv__UpdateTask_Request *)allocator.zero_allocate(size, sizeof(village_interfaces__srv__UpdateTask_Request), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = village_interfaces__srv__UpdateTask_Request__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        village_interfaces__srv__UpdateTask_Request__fini(&data[i - 1]);
      }
...
village_interfaces__srv__UpdateTask_Request__Sequence__fini(village_interfaces__srv__UpdateTask_Request__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      village_interfaces__srv__UpdateTask_Request__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  village_interfaces__srv__UpdateTask_Request__Sequence * array = (village_interfaces__srv__UpdateTask_Request__Sequence *)allocator.allocate(sizeof(village_interfaces__srv__UpdateTask_Request__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = village_interfaces__srv__UpdateTask_Request__Sequence__init(array, size);
  if (!success) {
...
village_interfaces__srv__UpdateTask_Request__Sequence__destroy(village_interfaces__srv__UpdateTask_Request__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    village_interfaces__srv__UpdateTask_Request__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
village_interfaces__srv__UpdateTask_Request__Sequence__are_equal(const village_interfaces__srv__UpdateTask_Request__Sequence * lhs, const village_interfaces__srv__UpdateTask_Request__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!village_interfaces__srv__UpdateTask_Request__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  village_interfaces__srv__UpdateTask_Request__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(village_interfaces__srv__UpdateTask_Request);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    village_interfaces__srv__UpdateTask_Request * data =
      (village_interfaces__srv__UpdateTask_Request *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!village_interfaces__srv__UpdateTask_Request__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          village_interfaces__srv__UpdateTask_Request__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!village_interfaces__srv__UpdateTask_Request__copy(
...
village_interfaces__srv__UpdateTask_Response__init(village_interfaces__srv__UpdateTask_Response * msg)
{
  ...
  // tasks_result
  if (!rosidl_runtime_c__int32__Sequence__init(&msg->tasks_result, 0)) {
    village_interfaces__srv__UpdateTask_Response__fini(msg);
    return false;
  }
  return true;
}
...
village_interfaces__srv__UpdateTask_Response__fini(village_interfaces__srv__UpdateTask_Response * msg)
{
  ...
  // tasks_result
  rosidl_runtime_c__int32__Sequence__fini(&msg->tasks_result);
}
...
village_interfaces__srv__UpdateTask_Response__are_equal(const village_interfaces__srv__UpdateTask_Response * lhs, const village_interfaces__srv__UpdateTask_Response * rhs)
{
  ...
  // tasks_result
  if (!rosidl_runtime_c__int32__Sequence__are_equal(
      &(lhs->tasks_result), &(rhs->tasks_result)))
  {
    return false;
  }
  return true;
  ...
  village_interfaces__srv__UpdateTask_Response * output)
{
  ...
  // tasks_result
  if (!rosidl_runtime_c__int32__Sequence__copy(
      &(input->tasks_result), &(output->tasks_result)))
  {
    return false;
  }
  return true;
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  village_interfaces__srv__UpdateTask_Response * msg = (village_interfaces__srv__UpdateTask_Response *)allocator.allocate(sizeof(village_interfaces__srv__UpdateTask_Response), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(village_interfaces__srv__UpdateTask_Response));
  bool success = village_interfaces__srv__UpdateTask_Response__init(msg);
  if (!success) {
    allocator.deallocate(msg, allocator.state);
    return NULL;
  }
...
village_interfaces__srv__UpdateTask_Response__Sequence__init(village_interfaces__srv__UpdateTask_Response__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  village_interfaces__srv__UpdateTask_Response * data = NULL;

  if (size) {
    data = (village_interfaces__srv__UpdateTask_Response *)allocator.zero_allocate(size, sizeof(village_interfaces__srv__UpdateTask_Response), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = village_interfaces__srv__UpdateTask_Response__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      // if initialization failed finalize the already initialized array elements
      for (; i > 0; --i) {
        village_interfaces__srv__UpdateTask_Response__fini(&data[i - 1]);
      }
      allocator.deallocate(data, allocator.state);
      return false;
    }
...
village_interfaces__srv__UpdateTask_Response__Sequence__fini(village_interfaces__srv__UpdateTask_Response__Sequence * array)
{
  ...
  if (array->data) {
    ...
    // finalize all array elements
    for (size_t i = 0; i < array->capacity; ++i) {
      village_interfaces__srv__UpdateTask_Response__fini(&array->data[i]);
    }
    allocator.deallocate(array->data, allocator.state);
    array->data = NULL;
    array->size = 0;
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  village_interfaces__srv__UpdateTask_Response__Sequence * array = (village_interfaces__srv__UpdateTask_Response__Sequence *)allocator.allocate(sizeof(village_interfaces__srv__UpdateTask_Response__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = village_interfaces__srv__UpdateTask_Response__Sequence__init(array, size);
  if (!success) {
    allocator.deallocate(array, allocator.state);
    return NULL;
  }
...
village_interfaces__srv__UpdateTask_Response__Sequence__destroy(village_interfaces__srv__UpdateTask_Response__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    village_interfaces__srv__UpdateTask_Response__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
village_interfaces__srv__UpdateTask_Response__Sequence__are_equal(const village_interfaces__srv__UpdateTask_Response__Sequence * lhs, const village_interfaces__srv__UpdateTask_Response__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!village_interfaces__srv__UpdateTask_Response__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  village_interfaces__srv__UpdateTask_Response__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(village_interfaces__srv__UpdateTask_Response);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    village_interfaces__srv__UpdateTask_Response * data =
      (village_interfaces__srv__UpdateTask_Response *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!village_interfaces__srv__UpdateTask_Response__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          village_interfaces__srv__UpdateTask_Response__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!village_interfaces__srv__UpdateTask_Response__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
