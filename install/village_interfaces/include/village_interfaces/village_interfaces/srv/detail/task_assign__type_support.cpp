...
void fetch_function__TaskAssign_Request__tasks(
  const void * untyped_member, size_t index, void * untyped_value)
{
  const auto & item = *reinterpret_cast<const int32_t *>(
    get_const_function__TaskAssign_Request__tasks(untyped_member, index));
  auto & value = *reinterpret_cast<int32_t *>(untyped_value);
  value = item;
}

void assign_function__TaskAssign_Request__tasks(
  void * untyped_member, size_t index, const void * untyped_value)
{
  auto & item = *reinterpret_cast<int32_t *>(
    get_function__TaskAssign_Request__tasks(untyped_member, index));
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember TaskAssign_Request_message_member_array[1] = {
  {
    ...
    fetch_function__TaskAssign_Request__tasks,  // fetch(index, &value) function pointer
    assign_function__TaskAssign_Request__tasks,  // assign(index, value) function pointer
...
void fetch_function__TaskAssign_Response__task_result(
  const void * untyped_member, size_t index, void * untyped_value)
{
  const auto & item = *reinterpret_cast<const int32_t *>(
    get_const_function__TaskAssign_Response__task_result(untyped_member, index));
  auto & value = *reinterpret_cast<int32_t *>(untyped_value);
  value = item;
}

void assign_function__TaskAssign_Response__task_result(
  void * untyped_member, size_t index, const void * untyped_value)
{
  auto & item = *reinterpret_cast<int32_t *>(
    get_function__TaskAssign_Response__task_result(untyped_member, index));
  const auto & value = *reinterpret_cast<const int32_t *>(untyped_value);
  item = value;
}
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember TaskAssign_Response_message_member_array[1] = {
  {
    ...
    fetch_function__TaskAssign_Response__task_result,  // fetch(index, &value) function pointer
    assign_function__TaskAssign_Response__task_result,  // assign(index, value) function pointer
