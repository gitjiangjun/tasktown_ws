...
#include "village_interfaces/msg/detail/task__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
  auto typed_message =
    static_cast<const village_interfaces::msg::Task *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<village_interfaces::msg::Task *>(
    untyped_ros_message);
...
{
  return &village_interfaces::msg::typesupport_fastrtps_cpp::_Task__handle;
}
