...
static const _TaskAssign_Request_type_support_symbol_names_t _TaskAssign_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, village_interfaces, srv, TaskAssign_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, village_interfaces, srv, TaskAssign_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, village_interfaces, srv, TaskAssign_Request)() {
  return &::village_interfaces::srv::rosidl_typesupport_c::TaskAssign_Request_message_type_support_handle;
}
...
static const _TaskAssign_Response_type_support_symbol_names_t _TaskAssign_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, village_interfaces, srv, TaskAssign_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, village_interfaces, srv, TaskAssign_Response)),
  }
};
...
ROSIDL_TYPESUPPORT_C_EXPORT_village_interfaces
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, village_interfaces, srv, TaskAssign_Response)() {
  return &::village_interfaces::srv::rosidl_typesupport_c::TaskAssign_Response_message_type_support_handle;
}
...
static const _TaskAssign_type_support_symbol_names_t _TaskAssign_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, village_interfaces, srv, TaskAssign)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, village_interfaces, srv, TaskAssign)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, village_interfaces, srv, TaskAssign)() {
  return &::village_interfaces::srv::rosidl_typesupport_c::TaskAssign_service_type_support_handle;
}
